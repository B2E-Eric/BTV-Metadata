export const assets = [
  ...
  },
  {
    ...
    type: 1,
    name: "Ship Pilot",
    description: "The pilot's job comes with a great deal of prestige, it requires one to be extremely talented or lucky enough to own a spaceship.\nPilots are the core of every fleet but their numbers are few as only a handful are good enough to obtain the title.",
    history: "This rank was awarded during crowdfunding for every 1,000 Nexium purchased",
    category: "rank",
    img: "Ship Pilot",
  },
  {
  ...
  },
  {
    ...
    description: "Death Stars are moving fortresses that serve as mobile stations for the Pilots and warships. Legends say they are powerful enough to turn entire planets into rubble.",
    history: "This rank was awarded during crowdfunding for every 16,000 Nexium purchased",
    category: "rank",
  ...
  },
  {
    ...
    type: 4,
    name: "Army General",
    description: "Army Generals command the Fleets and all the forces in space. To further augment their ability to lead and command they receive guidance from an AI. Army Generals are some of the most influential individuals in the universe.",
    history: "This rank was awarded during crowdfunding for every 50,000 Nexium purchased",
    category: "rank",
    img: "Army General"
  },
  {
    ...
    description: "Moons are rare but contain vast amounts of precious resources. The conditions are harsh for the colonists but the rewards well worth it.The Moon Administrator oversees the day to day activities on the moon and the exploitation of the precious resources.",
    history: "This rank was awarded during crowdfunding for every 100,000 Nexium purchased",
    category: "rank",
  ...
  },
  {
    ...
    description: "Constellation Kings are responsible for only the most important of matters. They decide where to expand and what star systems to colonize next. While called kings they are usually organizations or groups of people with very high morals and extreme foresight.",
    history: "This rank was awarded during crowdfunding for every 1,000,000 Nexium purchased",
    category: "rank",
  ...
  },
  {
    ...
    description: "We know very little about emperors. Some of them have connections to House Xoletsa which they seem to use as advisers.",
    history: "This rank was awarded during crowdfunding for every 1,700,000 Nexium purchased",
    category: "rank",
